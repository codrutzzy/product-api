...
class OrderRepository extends ServiceEntityRepository
{
     ...
     * @return int|mixed|string
     */
    public function listOrders(\DateTime $fromDate, \DateTime $toDate, int $limit = 10): array
    {
        return $this->createQueryBuilder('o')
            ->andWhere('o.status = :status')
            ->andWhere('o.updatedAt > :fromDate')
            ->andWhere('o.updatedAt < :toDate')
            ->setParameter('status', Order::STATUS_FINALISED)
